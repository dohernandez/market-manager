...
func NewUpdateWalletStocksDividend(walletFinder wallet.Finder, stockFinder stock.Finder) *updateWalletStocksDividend {
	return &updateWalletStocksDividend{
		walletFinder: walletFinder,
		stockFinder:  stockFinder,
	}
}

func (h *updateWalletStocksDividend) Handle(ctx context.Context, command cbus.Command) (result interface{}, err error) {
	wName := command.(*appCommand.UpdateWalletStocksDividend).Wallet
